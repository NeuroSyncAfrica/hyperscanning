...
# Update by Guillauem Dumas (2024)
#
...
# Need to change this for your Unicorn device id
device='/dev/cu.UN-20230701'
...
try:
    while True:
        ...
        for ch in range(0,8):
            ...
            if (eegv & 0x00800000):
                eegv = struct.unpack('>i', struct.pack('>I', eegv | 0xff000000))[0]
